...
const LayoutSection9 = () => {
  return (
    <div className='w-full bg-black h-[400px] flex flex-col justify-center items-center gap-9 px-9'>
        ...
        <p className='text-[#C084FC] text-center'>Enter your email to receive the latest MEV insights and updates.</p>
        <idv className="flex sm:flex-row flex-col gap-5">
            <input className="rounded-2xl px-5 sm:py-0 py-[0.75rem] bg-[#ccc] text-[#09090B]" placeholder='Enter your email address' />
