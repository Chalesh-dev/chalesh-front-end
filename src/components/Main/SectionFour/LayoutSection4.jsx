...
const LayoutSection4 = () => {
  return (
    ...
    >
      <p className="text-center lg:text-5xl md:text-4xl sm:text-3xl text-xl sm:!leading-[3.5rem] !leading-[2rem] font-bold w-auto max-w-[1300px]">
        Unraveling Blockchain Potential, One Mempool Insight at a Time{" "}
      </p>
      ...
      <ButtonCustom className=" bg-[#4F46E5] !text-white">
        Go to Product
      </ButtonCustom>
    </div>
  );
